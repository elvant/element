...
export default {
  ...
  props: {
    ...
    validator: function(value) {
      ...
      return ['direction', 'suggestion', 'logo', 'other'].indexOf(value) !== -1;
    }
  },
  data() {
    return {
