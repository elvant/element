...
| size  | control the size of components in this form | string | large / medium / small / mini | — |
...
| size  | control the size of components in this form-item | string | large / medium / small / mini | - |
